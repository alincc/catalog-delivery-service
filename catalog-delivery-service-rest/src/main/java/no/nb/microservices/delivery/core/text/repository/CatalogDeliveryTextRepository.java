...
public interface CatalogDeliveryTextRepository {
    ...
    @RequestMapping(value = "/catalog/v1/contenttext/alto/{urn}", method = RequestMethod.GET, produces = MediaType.APPLICATION_OCTET_STREAM_VALUE)
    ...
    @RequestMapping(value = "/catalog/v1/contenttext/text/{urn}", method = RequestMethod.GET)
